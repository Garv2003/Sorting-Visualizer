...
const page = () => {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#00000] bg-[radial-gradient(#ffffff33_1px,#150229_1px)] bg-[size:40px_40px]">
              ...
              <div className="flex w-full text-gray-400 p-4 rounded border border-system-purple20 bg-system-purple80 bg-opacity-10 gap-6">
                <div className="flex flex-col items-start justify-start w-3/4">
                  <h3 className="text-lg">
                    {SortingAlgorithmData[selectedAlgorithm].titile}
                  </h3>
